...
namespace lab123
{
    public class lab3 : Executor
    {
        static TupleTree[] tree;
        static bool draw = false;

        public lab3(string inputPath, string outputPath) : base(inputPath, outputPath) { }
