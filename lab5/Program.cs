    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<AuthDbContext>(options =>
                options.UseSqlServer("Server=tcp:pro-lab3server.database.windows.net,1433;Initial Catalog=lab3_database;Persist Security Info=False;User ID=bohdan;Password=;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"));
